...
namespace HR_PLUS.Infrastructure
{
    public class AppDbContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=tcp:hrplus.database.windows.net,1433;Initial Catalog=HRPLUS_DB;Persist Security Info=False;User ID=admin.hrplus;Password=hr.123456789;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;").UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            appUser.PasswordHash = ph.HashPassword(appUser, "hande.123");
            ...
            appUser4.PasswordHash = ph.HashPassword(appUser4, "burak.123");
